...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '216.24.57.1'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '216.24.57.1:8080')) if not ON_HEROKU or getenv('FQDN', '216.24.57.1:8080') else APP_NAME+'.herokuapp.com'
