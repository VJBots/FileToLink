...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'filestrea.onrender.com'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', 'filestrea.onrender.com:8080')) if not ON_HEROKU or getenv('FQDN', 'filestrea.onrender.com:8080') else APP_NAME+'.herokuapp.com'
