...
async def stream_start(client, message):
    ...
    await client.send_message(chat_id=message.from_user.id, text=msg_text.format(get_name(log_msg), humanbytes(get_media_file_size(message)), download, stream), quote=True, disable_web_page_preview=True, reply_markup=rm)
